...
class CFCPaymentPageNew extends StatefulWidget {
  ...
  const CFCPaymentPageNew(this.values, this.serviceCharges, {super.key});
  @override
  // ignore: no_logic_in_create_state
  _CFCPaymentPageNewState createState() => _CFCPaymentPageNewState(values, serviceCharges);
}

class _CFCPaymentPageNewState extends State<CFCPaymentPageNew> {
  Map<String, dynamic> values;
  List<dynamic> serviceCharges;
  _CFCPaymentPageNewState(this.values, this.serviceCharges);
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            borderRadius: BorderRadius.only(
                              bottomLeft: Radius.circular(Constants.getScreenWidth(context) * 0.1),
                              bottomRight: Radius.circular(Constants.getScreenWidth(context) * 0.1),
                                    ...
                                    child: ElevatedButton(
                                      onPressed: () {
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                            builder: (_) => SearchPageNew(values, serviceCharges),
                                          ),
                                        );
                                      },
                                          ...
                                          children: [
                                            TextSpan(
                                              ...
                                              style: TextStyle(
                                                  ...
                                                  color: const Color(0xff424242).withOpacity(.80),
                                                  fontFamily: 'Metropolis',
                                      ...
                                      child: RichText(
                                        ...
                                        text: TextSpan(
                                          children: [
                                            ...
                                            TextSpan(
                                              text:  (DateFormat('dd/MM/yyyy').format(DateTime.parse(_ePayExpiryDateTime))).toString(),
                                              style: TextStyle(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(
                                      ...
                                      child: ElevatedButton(
                                        onPressed: () {},
                                        style: ElevatedButton.styleFrom(
                                          backgroundColor: const Color(0xffFA6363),
                                          shape: RoundedRectangleBorder(
                                            borderRadius:
                                            BorderRadius.all(
                                        ...
                                        child: Text('Unpaid', style: TextStyle(
                                            fontSize: Constants.getGeneralFontSize(context)*0.012,
                                            color: Colors.white,
                                            fontFamily: 'Metropolis',
                                            fontWeight: FontWeight.bold
                                        )),
...
,
                              ...
                              Row(
                                ...
                                children: [
                                    ...
                                    child: Container(
                                      decoration: BoxDecoration(
                                        border:_isEncircled1?
                                        const Border(
                                          bottom: BorderSide(width: 5.0, color: Color(0xff32C774)),
                                        ):null,
                                        boxShadow: _isEncircled1
                                            ? [
                                          BoxShadow(
                                      ...
                                      child: Column(
                                        children: [
                                          Container(
                                            ...
                                            decoration: _isEncircled1?
                                            BoxDecoration(
                                              shape: BoxShape.circle,
                                              color: const Color(0xff00D95F).withOpacity(.12),
                                            ):
                                            BoxDecoration(
                                              shape: BoxShape.circle,
                                              color: const Color(0xff608DE2).withOpacity(.12),
                                            ),
                                            child: Padding(
                                              padding: EdgeInsets.all(
                                                MediaQuery.of(context).size.width * 0.04,
                                              ),
                                              child: Image.asset('assets/images/jazzcashlogo.png'),
                                            ),
                                          ),
                                          Padding(
                                            padding: EdgeInsets.only(
                                    ...
                                    child: Container(
                                      decoration: BoxDecoration(
                                        border:_isEncircled2?
                                        const Border(
                                          bottom: BorderSide(width: 5.0, color: Color(0xff32C774)),
                                        ):null,
                                        boxShadow: _isEncircled2
                                            ? [
                                          BoxShadow(
                                            color: Colors.green.withOpacity(0.5),
                                            spreadRadius: 2,
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Image.asset('assets/images/easypaisalogo.png'),
                                            ),
                                          ),
                                          Padding(
                                            padding: EdgeInsets.only(
                                    ...
                                    child: Container(
                                      decoration: BoxDecoration(
                                        border:_isEncircled3?
                                        const Border(
                                          bottom: BorderSide(width: 5.0, color: Color(0xff32C774)),
                                        ):null,
                                        boxShadow: _isEncircled3
                                            ? [
                                          BoxShadow(
                                            color: Colors.green.withOpacity(0.5),
                                            spreadRadius: 2,
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Image.asset('assets/images/raastlogo.png'),
                                            ),
                                          ),
                                          Padding(
                                            padding: EdgeInsets.only(
                                    ...
                                    child: Container(
                                      decoration: BoxDecoration(
                                        border:_isEncircled4?
                                        const Border(
                                          bottom: BorderSide(width: 5.0, color: Color(0xff32C774)),
                                        ):null,
                                        boxShadow: _isEncircled4
                                            ? [
                                          BoxShadow(
                                            color: Colors.green.withOpacity(0.5),
                                            spreadRadius: 2,
                                        ...
                                        children: [
                                          Container(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Image.asset('assets/images/onelinklogo.jfif'),
                                            ),
                                          ),
                                          Padding(
                                            padding: EdgeInsets.only(
                              ...
                              Padding(
                                ...
                                child: GestureDetector(
                                  onTap: () {
                                        ...
                                        return AlertDialog(
                                          ...
                                          content: Column(
                                            ...
                                            children: <Widget>[
                                              ...
                                              SizedBox(height: 20),
                                              Text(
                                                "Your application is not yet approved by the relevant departmet, you can process payment once approved by the department.",
                                                style: TextStyle(
                                                  fontSize: 16,
                                                ),
                                              ),
                                    ...
                                    if(_isEncircled1 == false && _isEncircled2 == false && _isEncircled3 == false && _isEncircled4 == false ) {
                                      ShowAlertDialogueClass.showAlertDialogue(context: context, title: "Payment Option!", message:"Please Select a payment option!", buttonText: "Okay!",iconData: Icons.error);
                                    } else if(values['paymentVia']=="JazzCash") {

                                      // Navigator.push(context, MaterialPageRoute(builder: (_)=>JazzCashCFCPaymentPageNew(values, serviceCharges)));
                                    }
                                    else if(values['paymentVia']=="EasyPaisa") {
                                      //Navigator.of(context).push(MaterialPageRoute(builder: (context) => EasyPaisaCFCPaymentPageNew(values)));
                                     // Navigator.push(context, MaterialPageRoute(builder: (_)=>EasyPaisaCFCPaymentPageNew(values, serviceCharges)));

                                    }
                                    else if(values['paymentVia']=="1Link") {
                                      //Navigator.of(context).push(MaterialPageRoute(builder: (context) => EasyPaisaCFCPaymentPageNew(values)));
                                      //Navigator.push(context, MaterialPageRoute(builder: (_)=>OneLinkCFCPaymentPageNew(values, serviceCharges)));

                                    }
                                    else
                                    {
                                     // Navigator.push(context, MaterialPageRoute(builder: (_)=>OneLinkInQuiryCFCPaymentPageNew(values, serviceCharges)));

                                      ShowAlertDialogueClass.showAlertDialogue(context: context, title: "Don't Worry!", message:"InshaAllah, will be implemented soon!", buttonText: "Okay!", iconData: Icons.error);
                                    }
                                  },
                                  child: Row(
                                    children: [
