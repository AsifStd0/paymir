...
class SuccessfulPaymentPageNew extends StatefulWidget {
  ...
  const SuccessfulPaymentPageNew(
    this.values,
    this.taxPercentage,
    this.totalAmount,
    this.mobileNumber,
  ...
  @override
  _SuccessfulPaymentPageNewState createState() =>
      _SuccessfulPaymentPageNewState(
        values,
        taxPercentage,
        totalAmount,
        mobileNumber,
                                          ...
                                          child: RichText(
                                            text: TextSpan(
                                              children: [
                                                TextSpan(
                                                  text:
                                                      "${DateFormat('d MMMM yyyy   |   h:mm a').format(DateTime.parse(values['entryDateTime']))}\n", //'10 April 2023   |   4:32 PM\n',
                                                  style: TextStyle(
                                                    color: const Color(
                                                      0xff424242,
                                                    ).withOpacity(0.60),
