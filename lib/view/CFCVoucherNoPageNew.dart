...
import 'CFCPaymentPageNew.dart';
import 'PaymentPageNew.dart';
import 'package:animated_text_kit/animated_text_kit.dart';

class CFCVoucherNoPageNew extends StatefulWidget {
  const CFCVoucherNoPageNew({super.key});

  @override
  _CFCVoucherNoPageNewState createState() => _CFCVoucherNoPageNewState();
}

class _CFCVoucherNoPageNewState extends State<CFCVoucherNoPageNew> {

  int _selectedIndex = 0;

  bool _isLoading = false;

  late var textController= new TextEditingController() ;//= MaskedTextController(mask: 'xxxx-0000-00-000000');
                   ...
                   // SizedBox(height: MediaQuery.of(context).size.height * 0.1),
                    Center(
                      child: TextButton(
                        ...
                        if(MyValidationClass.validateVoucher(textController.text)==null)
                        {
                          ...
                          if(await NetworkHelper.checkInternetConnection())
                          {
                            ...
                            if(textController.text == "BRCC-0001-24-100001" || textController.text == "brcc-0001-24-100001" || textController.text == "Brcc-0001-24-100001" ){

                       Navigator.push(context, MaterialPageRoute(builder: (_)=> CFCPaymentPageNew(
                                  {"arcid":10556,"dptPaymentID":"BRCC-0001-24-100001","trackingNumber":"BRCC-0001-24-100001","citizenCNIC":"17301-4338768-3","serviceName":"Birth Certificate","serviceID":0,"serviceTypeName":"New Birth Certificate (within 90 days)","departmentName":"Local Government, Election and Rural Development Department","departmentID":0,"feeAmount":500.0,"platformChargesPercentage":0.3,"statusCode":200,"statusMsg":"Request entertained successfully","ePayExpireDate":"2024-04-01T14:59:09.94","serviceKey":"WCBW-0001","applicationGenerationDateTime":null,"entryDateTime":"2024-03-22T14:54:35.77","paymentDate":"0001-01-01T00:00:00","responseStatus":true,"responseMessage":"Request entertained successfully","serviceD":null,"totalDeductibleAmount":0.0,"mobileNoForVoucher":null,"voucherAgainst":null,"redirectionURI":null}
                                  ,[])));
                            }
                            else {
                              showDialog(
                                  ...
                                  return AlertDialog(
                                    ...
                                    content: Column(
                                      ...
                                      children: <Widget>[
                                        ...
                                        SizedBox(height: 20),
                                        Text(
                                          "The application you entered does not exist!",
                                          style: TextStyle(
                                            fontSize: 16,
                                          ),
                                        ),
