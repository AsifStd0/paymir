...
import '../view/OneLinkInQuiryPaymentPageNew.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/svg.dart';
import 'package:intl/intl.dart';
import '../view/EasyPaisaPaymentPageNew.dart';
import '../view/JazzCashPaymentPageNew.dart';
...
class PaymentPageNew extends StatefulWidget {
  ...
  _PaymentPageNewState createState() => _PaymentPageNewState(values, serviceCharges);
}
                                  ...
                                  onTap: () {
                                    ...
                                    if(_isEncircled1 == false && _isEncircled2 == false && _isEncircled3 == false && _isEncircled4 == false ) {
                                      ShowAlertDialogueClass.showAlertDialogue(context: context, title: "Payment Option!", message:"Please Select a payment option!", buttonText: "Okay!",iconData: Icons.error);
                                       ...
                                       Navigator.push(context, MaterialPageRoute(builder: (_)=>JazzCashPaymentPageNew(values, serviceCharges)));
                                    }
                                      ...
                                      Navigator.push(context, MaterialPageRoute(builder: (_)=>EasyPaisaPaymentPageNew(values, serviceCharges)));

                                    }
                                    else if(values['paymentVia']=="1Link") {
                                      //Navigator.of(context).push(MaterialPageRoute(builder: (context) => EasyPaisaPaymentPageNew(values)));
                                      Navigator.push(context, MaterialPageRoute(builder: (_)=>OneLinkPaymentPageNew(values, serviceCharges)));
